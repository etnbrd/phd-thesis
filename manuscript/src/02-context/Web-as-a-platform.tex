...
Since the web allowes an application to scale world wide with near zero latency, the software industry needed innovative solutions to cope with large network traffic.
...
The former presents limited scalabiity, whereas the latter does not.
