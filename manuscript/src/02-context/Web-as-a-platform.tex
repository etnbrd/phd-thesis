...
In 2008\nt{TODO verify date} Google released V8 for its browser Chrome.
...
\setupchronoevent{textstyle=\scriptsize,datestyle=\scriptsize\bf,datesseparation=/,conversionmonth=false}
...
\event[50pt]  {06/2015}     {ECMAScript v6.0}
\event[10pt]  {14/01/2015}  {io.js}
\event[170pt] {06/2011}     {ECMAScript V5.1}
\event[130pt] {12/2009}     {ECMAScript v5.0}
\event[90pt]  {27/06/2009}  {Node.js}
\event[50pt]  {02/09/2008}  {V8}
\event[10pt]  {22/01/2008}  {HTML5 public draft}
\event[10pt]  {04/06/2004}  {WHATWG}
\event[170pt] {12/1999}     {ECMAScript v3.0}
\event[130pt] {06/1998}     {ECMAScript v2.0}
\event[90pt]  {06/1997}     {ECMAScript v1.0}
\event[50pt]  {11/1996}     {ECMA Standardization}
