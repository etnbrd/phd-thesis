...
\nt{Reduce the section historical context to the minimum, it just need to show the evolution of Javascript from evil to best language}
...
\nt{This paragraph seems too technical to be here}
