...
% Eventually this fragmented market of platform was reunited with the specification of high-level, inter-OS programming languages.
% Applications could be developed, and run on any operating system.
...
\comment{TODO This subsection needs reviews. The message is still not clear.}
...
\comment{TODO More arguments needed here. Java is overengineered, overtooled, too verbose, it is not dynamic enough : OOP is outdated, and it lacks lambdas, and so on ...}
...
\comment{TODO why Ruby could have replaced Java ? dynamic language, functional paradigm}
...
\comment{TODO un peu rapide ici}
\comment{TODO I should note the distinction between Javascript client and server side. There is no choice on the client, while there is a choice on the server. So the popularity on the client is not as significant than on the server. However, as I said, Javascript unavoidable position made its success and its performance.}
