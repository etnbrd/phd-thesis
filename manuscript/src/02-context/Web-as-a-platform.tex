...
\nt{TODO This subsection needs reviews. The message is still not clear.}


\subsection{The languages of the web}\nt{TODO This subsection needs reviews, it is poorly written.}
...
\nt{TODO More arguments needed here. Java is overengineered, overtooled, too verbose, it is not dynamic enough : OOP is outdated, and it lacks lambdas, and so on ...}
...
\nt{TODO why Ruby could have replaced Java ? dynamic language, functional paradigm}
...
This brought open source and collaborative development before github. \nt{TODO neither open source nor collaborative development are the correct terms}
...
\nt{TODO why is Javascript unpopular ? cite some blog post like : https://wiki.theory.org/YourLanguageSucks\#JavaScript\_sucks\_because and add many blog posts titles in a mozaïc}
