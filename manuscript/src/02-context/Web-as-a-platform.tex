...
The pipeline architecture is difference as each task is executed on an isolated stage.
Whereas in the event-loop execution model, all handlers share the same queue, loop and memory store.
...
\begin{figure}[h!]
  ...
  \caption{Difference between the two execution models}
\end{figure}
