...
% TODO reformulate that and find a good example here
...
% TODO explain what is the common point between a GUI and a real-time web server -> lots of I/O, very few computations.
...
It is designed to adapt a reduced number of resources (namely one thread of execution) to a various, and growing number of thread of logical execution.
