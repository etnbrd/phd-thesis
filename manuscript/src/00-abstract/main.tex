...
L'objectif de cette thès est de maintenir une double représentation d'un code Javascript grace à une équivalence entre l'approche modulaire, et l'approche pipeline d'un même programme.
...
La seconde proposant une execution plus efficace que la première en permettant de rendre certaines parties du code relocalisable en cours d'execution.
...
Ce travail s'est fait de manière concrète dans le cadre d'une thèse CIFRE dans la société Worldline.
