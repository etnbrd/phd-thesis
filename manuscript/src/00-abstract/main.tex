...
Internet étend nos moyens de communications, et réduit leur latence ce qui permet de développer l'économie à l’échelle planétaire.
...
Des langages tel que Ruby ou Java se sont imposés comme les langages du web, justement parce qu'ils suivent cette approche qui permet d'intégrer facilement de nouvelles fonctionnalités.
...
Or il est difficile pour une application suivant l'approche modulaire d'être \textit{scalable}.
...
De plus, l'équipe de développement dois concilier cette nouvelle approche de développement \textit{scalable}, avec la demande en fonctionnalités.
...
La seconde proposant une exécution plus efficace que la première en permettant de rendre certaines parties du code relocalisables en cours d’exécution.
