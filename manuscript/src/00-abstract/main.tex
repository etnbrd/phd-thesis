...
Internet étend nos moyens de communication, et réduit leur latence.
Cela permet de développer l'économie à l’échelle planétaire.
...
Son audience peut prendre plusieurs ordres de grandeurs en quelques jours seulement, ou même en quelques heures suivant l'ampleur de la propagation.
