...
\chapter{Distributed web applications}
  ...
  \section{Framworks for web application distribution \comment{(State of the art)}}
    \subsection{Micro-batch processing}
    \subsection{Stream Processing}

  \section{Fluxionnal execution model \comment{(Contribution)}}
...
\chapter{Pipeline parallelism for web applications}
  ...
  \section{Languages and compilers \comment{(State of the art)}}
  ...
  \section{Fluxionnal Compiler \comment{(Contribution)}}
