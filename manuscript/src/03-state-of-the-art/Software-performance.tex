\section{Performance Efficiency Focused Platforms} \label{chapter3:software-performance}
...
\ConcurrentPerformanceTable{tab:performance-concurrency}
...
\ParallelPerformanceTable{tab:performance-parallel}
...
Go is an open source language initiated by Google to build highly concurrent services \ftnt{https://golang.org/}.
...
\ParallelAdoptionTable{tab:performance-adoption}
...
% prevent higher-order programming between tasks, hence impacts maintainability.
...
\PerformanceMaintainabilityTable{tab:performance-maintainability}
...
\PerformanceSummaryTable{tab:performance-synthesis}
