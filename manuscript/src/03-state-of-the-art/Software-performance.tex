...
This decomposition allows the fine level sequentiality, and coarse level message passing required by scalability.
...
\textit{The purpose of explicit synchronization is to manage the timing of side-effects in the presence of parallelism.}\ftnt{http://pchiusano.blogspot.com/2010/01/actors-are-not-good-concurrency-model.html?showComment=1267337235223\#c3014836700278061280}
...
% \url{https://commons.wikimedia.org/wiki/File:SIMD.svg}
% \url{https://commons.wikimedia.org/wiki/File:MISD.svg}
% \url{https://commons.wikimedia.org/wiki/File:MIMD.svg}
\end{center}
...
%
% \multicolumn{3}{c}{}  & \rot{Concurrency} & \multicolumn{2}{|c}{Parallelism} \\
Model & Implementations    & \rot{Community adoption} & \rot{Industrial adoption} & \rot{Web compliant} & $\to$ & \rot{Organic Growth} \\
\tabucline[.5pt]{-}
% %                                                                               COM  IND  WEB   GRO
