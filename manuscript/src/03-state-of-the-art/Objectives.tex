...
\nt{There is no higher-level programming in parallel programming, and lazy evaluation / pipeline is present in both parallelism and functional programming, so a parallel programming model lacks a higher-level programming capability to be modular and parallel. This thesis intends to bring higher-level programming to an existing lazy evaluation / pipeline programming model, and parallelism.}
