...
This execution model is very efficient for highly concurrent applications, as it avoids contention due to waiting for shared resources like disks, or network.
...
% \begin{figure}
% \begin{center}
% \includegraphics[width=0.2\textwidth]{../resources/SISD.pdf}
% \includegraphics[width=0.2\textwidth]{../resources/SIMD.pdf}
% \includegraphics[width=0.2\textwidth]{../resources/MISD.pdf}
% \includegraphics[width=0.2\textwidth]{../resources/MIMD.pdf}\\
