...
Promise were introduced as an help to nicely chain these concurrent tasks \cite{Liskov1988}.
...
Developers cannot protect atomicity of operations, which increase the likeliness of race conditions \ftnt{https://glyph.twistedmatrix.com/2014/02/unyielding.html}.
