...
Moreover, a balance between productivity and efficiency is required to be both supported by the community and needed by the industry, hence triggers a virtuous circle of adoption.
...
At runtime, the uncertainties on the independence of tasks is resolved.
