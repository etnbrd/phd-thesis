...
\newcommand{\SummaryHeader}         { Model  &   \lab{Productivity} &   \lab{Adoption} &   \lab{Efficiency} \\ \tabucline[.5pt]{-}}
\newcommand{\SummaryRow}            {\Model  & \rate{\Productivity} & \rate{\Adoption} & \rate{\Efficiency}}
...
\newcommand{\ConcurrentEfficiencyTable}[1]{
  \begin{table}[H]
  \tikzexternaldisable
  \begin{tabu} to \linewidth {@{} X[l] *{\the\numexpr\EfficiencyCol}{c} @{}}
  \EfficiencyHeader
  ...
  \end{tabu}
  \tikzexternalenable
  \caption{Efficiency of Concurrent Programming Platforms}
  \label{#1}
  \end{table}
}
