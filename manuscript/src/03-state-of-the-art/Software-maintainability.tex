\section{Maintainability Focused Platforms} \label{chapter3:software-maintainability}
...
\end{center}
\caption{Focus on Maintainability}
...
\ModularMaintainabilityTable{tab:maintainability-modularity}
...
\end{center}
\caption{Steer back toward Performence Efficiency}
...
% ->_>_>_>_> These implementations steer back from maintainability into performance efficiency, as shown by \circled{2} in figure \ref{fig:modular-programming-state-of-the-art-2}.
...
\ModularAdoptionTable{tab:maintainability-adoption}
...
\ModularPerformanceTable{tab:maintainability-performance}
...
\ModularSummaryTable{tab:maintainability-synthesis}
