...
\begin{figure}[h!] \label{fig:modular-programming-state-of-the-art-1}
\begin{center}
...
Model & Implementations    & \rot{Higher-Order Programming} & \rot{Lazy evaluation, or streaming composition} & \rot{Encapsulation} & $\to$ & \rot{Maintainability} \\
\tabucline[.5pt]{-}%
...
These implementations often break apart from pure maintainability to wander back into performance efficiency, as shown by \circled{2} in figure \ref{fig:modular-programming-state-of-the-art-2}.
...
%
% \multicolumn{3}{c}{}  & \rot{Concurrency} & \multicolumn{2}{|c}{Parallelism} \\
Model & Implementations    & \rot{Maintainability} & \rot{Organic Growth} & \rot{Scalability} \\
\tabucline[.5pt]{-}
%                                                                                MOD  GRO  SCL
