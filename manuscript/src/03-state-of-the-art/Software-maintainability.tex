\section{Maintainability Focused Environements} \label{chapter3:software-maintainability}
...
Section \ref{chapter3:software-maintainability:adoption} presents the adoption of the implementations of modular programming languages.
...
\subsection{Modular Programming} \label{chapter3:software-maintainability:modularity}
...
% % \subsubsection{Design Choices} \label{chapter3:software-maintainability:design-choices}
...
% Section \ref{chapter3:software-maintainability:design-choices} presents the decomposition.

% \subsubsection{Programming Models} \label{chapter3:software-maintainability:programming-models}

% \subsubsection{Features} \label{chapter3:software-maintainability:modularity:features}
...
% \subsubsection{Programming Models} \label{chapter3:software-maintainability:modularity:programming-models}
...
It defined the core concepts of OOP as message passing, encapsulation, and late-binding\ftnt{http://userpage.fu-berlin.de/~ram/pub/pub\_jf47ht81Ht/doc\_kay\_oop\_en}.
...
These recent multi-paradigms languages like Javascript, Python, Ruby and Go combine the different paradigms to help developer building applications faster.
% They provide encapsulation, higher-order programming and stream composition.

\paragraph{}

Table \ref{tab:maintainability-modularity} presents a summary of the analysis of the programming models presented in the previous paragraphs.
...
Model & Implementations    & \lab{Composition} & \lab{Encapsulation} & $\to$ & \lab{Maintainability} \\
\tabucline[.5pt]{-}%
...
\subsection{Adoption} \label{chapter3:software-maintainability:adoption}
...
These implementations steer back from maintainability into performance efficiency, as shown by \circled{2} in figure \ref{fig:modular-programming-state-of-the-art-2}.
...
It represents more than $320000$ repositories on \textit{Github}.
The second language is Java with more than $220000$ repositories.
It is cited in more than $960000$ questions on \textit{StackOverflow} while the second is Java with around $940000$ questions.
...
Table \ref{tab:maintainability-adoption} presents a summary of the analysis of the programming models presented in the previous paragraphs.
...
%
% \multicolumn{3}{c}{}  & \lab{Concurrency} & \multicolumn{2}{|c}{Parallelism} \\
Model & Implementations    & \lab{Community support} & \lab{Industrial need} & $\to$ & \lab{Adoption} \\
\tabucline[.5pt]{-}
%                                                                               COM  IND   ADO
Imperative Programming         & C                                             & \V & \V && \V \\ \tabucline[on .5pt]{-}
Object-Oriented Programming    & C++, Java                                     & \V & \V && \V \\ \tabucline[on .5pt]{-}
Functional Programming         & Scheme, Miranda, Haskell                      & \X & \X && \X \\ \tabucline[on .5pt]{-}
Dynamic Scripting              & Javacript, Python, Ruby, Go                   & \V & \V && \V \\
\tabucline[.5pt]{-}
\end{tabu}
\caption{Analysis of the state of the art in modular programming regarding adoption}
\label{tab:maintainability-adoption}
\end{table}
...
Functional programming rely on immutable state, comparable to message-passing, which might impacts performance at fine-grain level when used inefficiently, because of heavy memory usage.
...
The table \ref{tab:maintainability-performance} presents the performance limitations of the languages presented in this section.
It only presents programming languages.
All platforms improving on these languages to provide performances are addressed in the next section.
...
%
% \multicolumn{3}{c}{}  & \lab{Concurrency} & \multicolumn{2}{|c}{Parallelism} \\
Model & Implementations    & \lab{Synchronization} & \lab{Message-passing} & $\to$ & \lab{Performance Efficiency} \\
\tabucline[.5pt]{-}
%                                                                               SHA  IMU  SCL
...
\label{tab:maintainability-performance}
\end{table}
...
Table \ref{tab:maintainability-synthesis} summarizes the characteristics of the solutions presented in this section.
...
\label{tab:maintainability-synthesis}
\end{table}
...
% \subsubsection{Performance Limitations} \label{chapter3:software-maintainability:limitations}
