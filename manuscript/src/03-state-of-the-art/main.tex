...
Throughout this chapter, the different works from the community are classified into three categories : focus on implementation evolution, focus on parallel execution in section \ref{chapter3:software-efficiency}, or reconciliation of the two in section \ref{chapter3:reconciliation}.
And finally, section \ref{chapter3:objectives} presents the objectives for this thesis.

\input{03-state-of-the-art/Software-design}
\input{03-state-of-the-art/Software-efficiency}
\input{03-state-of-the-art/Reconciliations}
