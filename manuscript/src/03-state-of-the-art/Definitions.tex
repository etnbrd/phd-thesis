...
% To improve productivity, the definition of modules needs to increase cohesion, and decrease coupling.
...
% The productivity of a platform depends on the modularity allowed by the platform
...
% Modular Programming stands upon Structured Programming 
...
% The criteria to analyze the performance efficiency of platforms are the following.
...
% \item Coarse-level state independence
