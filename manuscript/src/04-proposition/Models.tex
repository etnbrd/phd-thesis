...
The event-driven execution model is processes a queue of asynchronous events by cooperatively scheduling handlers.
...
Listing~\ref{lst:then} illustrate a simple promise.
