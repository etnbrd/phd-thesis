...
The handlers \circled{\fontsize{12pt}{10pt}\selectfont\figcapfont 1} and \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont 2} rely on the same memory, and are scheduled sequentialy.
WHereas the handler \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont 3} is independent, and can be executed in parallel.
