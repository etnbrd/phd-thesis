...
$\to$
\circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_1$} $\to$
\circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_2$} $\to$ and \\
...
\circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_2$} $\to$ and \\
\dotcircled{\textcolor{white}{0}} $\to$
\circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $B_1$} $\to$
\dotcircled{\textcolor{white}{0}}.
...
As illustrated in figure \ref{fig:memory-update}, the upstream handler \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont 1} communicates the memory update to the downstream handler \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_2$}.
...
The handlers \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_1$} and \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $B_1$} rely on the same memory, and are scheduled sequentialy.
WHereas the handler \circled{\fontsize{10pt}{10pt}\selectfont\figcapfont $A_2$} is independent, and can be executed in parallel.
