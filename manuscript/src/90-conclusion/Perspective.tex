...
Yet, some examples show that this shift might actually already be rising.
The platform Squarespace\ftnt{http://www.squarespace.com/}, and even further the soon to come Grid\ftnt{https://thegrid.io/}, allows everyone to launch a commercial website for its business without any required programming knowledge.
