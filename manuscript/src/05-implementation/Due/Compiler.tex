...
Because Dues are a placeholder for a single outcome, it doesn't allow to express the streaming of data.
Concretely, in the case of streaming data, a Due is created for each datum in the stream.
Therefore, this pipeline of Dues doesn't represent the whole streaming pipeline underlying in the application.
