...
\newcommand{\ConclusionCol}            {4}
\newcommand{\ConclusionHeader}         { Model &   \lab{Productivity} &   \lab{Efficiency} & - &   \lab{Adoption} \\ \tabucline[.5pt]{-}}
\newcommand{\ConclusionRow}            {\Model & \rate{\Productivity} & \rate{\Efficiency} & - & \rate{\Adoption}}
...
\newcommand{\TablePropositionSummary}[1]{
  \begin{table}[H]
  \tikzexternaldisable
  \begin{tabu} to \linewidth {@{} X[2,l] *{\the\numexpr\SummaryCol}{c} @{}}
  \ConclusionHeader%
  \PropositionConclusion%
  \end{tabu}
  \tikzexternalenable
