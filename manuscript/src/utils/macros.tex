...
\definecolor{LIGHTGRAY}{RGB}{253,251,247}
% \definecolor{LIGTHGRAY}{RGB}{253,251,247}
\definecolor{TITLE}{RGB}{36, 34, 31}
...
\newcommand{\cit}[2]{%
  \vskip \baselineskip%
  \textit{%
    \llap{\hfill\quotefont\fontsize{45pt}{45pt}\selectfont\textcolor{red}{“}\hspace{15pt}}%
    \vskip -2.2\baselineskip%
    \noindent\Large{#1}{\quotefont\textcolor{red}{”}}%
  }%
  \begin{flushright}%
  --- #2%
  \end{flushright}%
...
\newcommand{\citi}[2]{%
  \vskip \baselineskip%
  \textit{%
    \llap{\hfill\quotefont\fontsize{45pt}{45pt}\selectfont\textcolor{red}{“}\hspace{25pt}}%
    \vskip -2.2\baselineskip%
    \noindent\Large{#1}{\quotefont\textcolor{red}{”}}%
  }%
  \begin{flushright}%
...
\newcommand{\bigfig}[1]{%
  \fboxsep 20pt%
  \makebox[\textwidth][c]{\colorbox{LIGHTGRAY}{\parbox{\figurewidth}{#1}}}%
}

\newcommand{\textfig}[1]{%
  \fboxsep 0pt%
  \makebox[\textwidth][c]{\colorbox{LIGHTGRAY}{\parbox{\textwidth}{\vspace{20pt}\centering#1\vspace{20pt}}}}%
}
...
\newcommand{\marginfig}[3]{%
  ...
  \begin{wrapfigure}[#1]{R}[0.25\textwidth]{0pt}%
    \makebox[#2]{\hfill\vspace{-2000pt}\colorbox{LIGHTGRAY}{#3}\hspace{20pt}}%
  \end{wrapfigure}%
}
