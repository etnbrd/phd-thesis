...
\titleformat{\section}
  {\needspace{5\baselineskip}\vspace{20pt}\secfont\fontsize{28pt}{28pt}\selectfont}
...
\titleformat{\subsection}[block]%
  {\needspace{5\baselineskip}\vspace{10pt}\secfont\fontsize{20pt}{20pt}\selectfont} % format
  {\llap{\hspace*{-\rulelen}\hfill\thesubsection\hspace{10pt}}}
  {0pt} % sep
  {#1\vspace{10pt}} % before
  % [\normalfont\vspace{10pt}] % after

\titleformat{\subsubsection}%
  {\needspace{5\baselineskip}\secfont\fontsize{17pt}{17pt}\selectfont} % format
  {}
...
\titleformat{\paragraph}%
  {\needspace{3\baselineskip}\secfont\fontsize{12pt}{12pt}\selectfont} % format
  {}
  {0pt} % sep
  {#1} % before
