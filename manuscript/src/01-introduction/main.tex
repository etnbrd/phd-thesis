...
\marginfig{12}{0.5\textwidth}{
  \includegraphics[width=0.3\textwidth]{../resources/mac.png}%
  \illustration{Ayib Makmun \url{http://bit.ly/original-mac}}
}
...
% \illustration{TODO amazed child in front of a computer}
...
Indeed, the lack of market need is the first reason for startup failure.\ftnt{http://bit.ly/startup-failures}
